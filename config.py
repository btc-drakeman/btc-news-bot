...
SYMBOLS = ['BTCUSDT', 'ETHUSDT', 'ETHFIUSDT', 'SUIUSDT', 'XRPUSDT', 'DOGEUSDT', 'WLDUSDT', 'PEPEUSDT', 'SEIUSDT', 'LINKUSDT', 'APTUSDT', 'FLOKIUSDT', 'ANIUSDT', 'SPKUSDT', 'PUMPUSDT', 'OMNIUSDT', 'MOCAUSDT', 'BONKUSDT', 'TONUSDT']
